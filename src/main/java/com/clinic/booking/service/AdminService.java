...
public class AdminService {
    ...
    /**
     * RESTORED - this method was accidentally dropped in a prior rewrite,
     * which is why the /today/pdf endpoint was silently returning nothing
     * to route to. Generates a fresh PDF from whatever's currently
     * booked, every call - reuses getTodayBookings() directly, so calling
     * this again later after more bookings come in produces an
     * up-to-date file.
     */
